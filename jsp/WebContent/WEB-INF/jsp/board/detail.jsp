...
<table>
	...
	<tr>
		<td colspan="3"><c:out value='${board.content}' escapeXml="true"/></td>
	</tr>
	<tr>
		<td colspan="3">
		<div class="float-end">
			<a href="list?category=${board.category}&pageNum=${pageNum}"><button class="btn btn-outline-primary" id="btnLt">목록</button></a>
			<c:if test="${member.id == board.id}">
				<a href="write?bno=${board.bno}&pageNum=${pageNum}"><button class="btn btn-outline-primary">수정</button></a>
...
<div class="col-6 mx-auto">
	<div class="form-group clearfix">
		...
		<button class="btn btn-outline-primary float-end disabled" id="btnReplyWrite">등록</button>
		</form>
	</div>
</div>
</c:if>
